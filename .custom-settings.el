(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval progn
     ...
     (cider-print-fn . "(fn [expr stream] (if (emmy.expression/literal? expr) (emmy.expression/expression->stream expr stream) (nrepl.middleware.print/*print-fn* expr stream)))")
